...
public class TampilLokasi extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TampilLokasi.this,"Fetching...","Wait...",false,false);
            }
    ...
    private void updateEmployee(){
        ...
        final String longi = editTextLong.getText().toString().trim();
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TampilLokasi.this,"Updating...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(TampilLokasi.this,s,Toast.LENGTH_LONG).show();
            }
    ...
    private void deleteEmployee(){
        class DeleteEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TampilLokasi.this, "Updating...", "Tunggu...", false, false);
            }
        ...
        alertDialogBuilder.setPositiveButton("Ya",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteEmployee();
                        startActivity(new Intent(TampilLokasi.this,TampilSemuaLokasi.class));
                    }
                });
